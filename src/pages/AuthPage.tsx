...
import { Mail, Lock, User, Eye, EyeOff, Scale, Shield, Zap, AlertCircle, CheckCircle, ArrowLeft, Home } from 'lucide-react';
    ...
    try {
      if (currentView === 'login') {
        ...
        if (error) {
          ...
          // Successful login - the useAuth hook will handle the redirect
          onBack();
        }
        ...
        <div className="w-full max-w-md">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-8">
            ...
            {currentView === 'register' && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl mb-6">
                <div className="text-center">
            ...
            {currentView === 'forgot-password' && (
              <button
                onClick={() => switchView('login')}
                className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors mb-6"
              >
                <ArrowLeft size={16} />
            ...
            {currentView === 'check-email' ? (
              ...
              <>
                ...
                {currentView === 'register' && (
                  <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl border border-blue-200 dark:border-blue-800 mt-6">
