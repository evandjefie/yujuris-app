...
import { Mail, Lock, User, Eye, EyeOff, Scale, Shield, Zap } from 'lucide-react';
      ...
      <div className="space-y-8">
        ...
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
            {isLogin ? 'Bienvenue sur Yujuris' : 'Rejoignez Yujuris'}
          </h2>
          <p className="text-gray-600 dark:text-gray-400">
            {isLogin 
              ? 'Connectez-vous à votre assistant juridique OHADA' 
              : 'Créez votre compte et accédez au droit OHADA simplifié'
            }
          </p>
        </div>
        ...
        <div className="flex bg-gray-100 dark:bg-gray-700 rounded-xl p-1">
          <button
            ...
            style={isLogin ? { backgroundColor: COLORS.primary } : undefined}
          >
            Connexion
          </button>
          <button
        ...
        <div className="text-center">
          ...
          >
            {isLogin ? 'Créez votre compte gratuitement' : 'Connectez-vous'}
          </button>
        </div>
